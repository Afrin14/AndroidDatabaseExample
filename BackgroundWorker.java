...
public class BackgroundWorker extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://192.168.0.9/myapppractice/MyApp1/login.php";
        String register_url = "http://192.168.0.9/myapppractice/MyApp1/register.php";
